...
COMING_SOON_HTML = r"""
<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><title>{{ title }}</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>body{font-family:Tahoma,Arial,sans-serif;background:#f4f1ea;margin:0;color:#2d2926;line-height:1.9}.container{max-width:800px;margin:0 auto;padding:18px}.card{background:#fffdf8;border:1px solid #ded4c4;border-radius:18px;padding:24px;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,.05)}a{display:inline-block;background:#6f4e37;color:#fff;text-decoration:none;padding:10px 14px;border-radius:12px;font-weight:bold;margin:6px}</style><!-- Google AdSense Auto Ads --><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8021374675748501" crossorigin="anonymous"></script></head><body><div class="container"><div class="card"><h1>{{ title }}</h1><p>هذا القسم موجود ضمن هيكل المنصة، وسيتم ربط التطبيق الخاص به لاحقًا.</p><a href="/">العودة للرئيسية</a><a href="/profile">بياناتي الفلكية</a></div></div></body></html>
"""
