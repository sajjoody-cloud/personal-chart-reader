...
<div class="note">ملاحظة: التقرير قراءة فلكية رمزية. في الصحة والقانون والمال القرار العملي يبقى للمختص.</div>
{% if user_report %}<div class="card"><h2>التقرير الأولي المجاني</h2><div class="result-box">{{ user_report }}</div><div class="locked-reason">لماذا ظهرت هذه النتيجة؟ التفاصيل الفنية، نقاط المنتصف، حدود بطليموس، البروفكشن، الفريدار، التقدم الثانوي، والقوس الشمسي متاحة في التقرير الاحترافي.</div></div><div class="pro-box"><div class="pro-title">🔒 التقرير الاحترافي الكامل</div><p>هذا التقرير يعطيك القراءة العميقة للحالة المختارة، وليس مجرد نتيجة مختصرة.</p><div class="pro-grid"><div class="pro-item">تحليل نقاط المنتصف المفعلة</div><div class="pro-item">البروفكشن السنوي والشهري واليومي</div><div class="pro-item">الفريدار والمرحلة الزمنية</div><div class="pro-item">العودة الشمسية والقمرية</div><div class="pro-item">التقدم الثانوي والقوس الشمسي</div><div class="pro-item">أفضل الفترات وفترات الحذر</div><div class="pro-item">حدود بطليموس ونوعية الدلالة</div><div class="pro-item">التقرير الفني للباحث</div></div><p>رقم الطلب: <span class="order-code">{{ forecast_order_id }}</span></p><p class="muted">لا حاجة لإرسال بيانات الميلاد مرة أخرى، يكفي إرسال رقم الطلب إلى @Astrol25.</p><a class="telegram-btn" href="{{ forecast_telegram_url }}" target="_blank" rel="noopener">طلب التقرير الاحترافي عبر تيليغرام</a></div>{% endif %}
</div></body></html>
"""
